...
if password == ("03094161457"):																	
     os.system('clear')																	
																	
     print 'Assalamu.alaikum ' + name + ' Welcome'																	
     time.sleep(0.8)																	
     print 'Welcome ' + name + ' lovehacker'																	
     time.sleep(0.8)																	
     print 'Semoga beruntung ' + name + ' lovehacker'																	
     time.sleep(0.8)																	
     ...
     print ("Ap ka Darj kia password Galat ha Lovehacker sy help lain (+923094161457)")																	
     os.sys.exit()																	
#-Out-#																	
def keluar():																	
